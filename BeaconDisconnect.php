...
mysqli_select_db($connect,'ansehen');
$sql_i="insert into USER_INFO (unique_key) values '111111111'";
...
$data_send = $BeaconId." ".$primaryKey."\0";
echo $data_send."<br>";

socket_write($socket,$data_send,strlen($data_send)+1);
